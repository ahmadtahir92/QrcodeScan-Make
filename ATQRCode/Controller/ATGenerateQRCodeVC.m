...
@interface ATGenerateQRCodeVC ()

@end

@implementation ATGenerateQRCodeVC
...
- (void)setupGenerateQRCode {
    ...
    imageView.image = [ATQRCodeTool AT_generateWithDefaultQRCodeData:@"https://github.com/kingsic" imageViewWidth:imageViewW];
...
- (void)setupGenerate_Icon_QRCode {
    ...
    imageView.image = [ATQRCodeTool AT_generateWithLogoQRCodeData:@"https://github.com/kingsic" logoImageName:@"icon_image" logoScaleToSuperView:scale];
...
- (void)setupGenerate_Color_QRCode {
    ...
    imageView.image = [ATQRCodeTool AT_generateWithColorQRCodeData:@"https://github.com/kingsic" backgroundColor:[CIColor colorWithRed:1 green:0 blue:0.8] mainColor:[CIColor colorWithRed:0.3 green:0.2 blue:0.4]];
}
